...
import useHostSellMyVeiclesCar from "../../../../../../hooks/useHostSellMyVeiclesCar";
import DetailsTabSellCarComponent from "./DetailsTabSellCarComponent";
import "../MyVehicles.css";

const MyVehicleDetails = () => {
  const [hostMySellVeiclesList, setHostMySellVeiclesList] =
    useHostSellMyVeiclesCar();
    ...
    <>
      <div className="cr-accordion">
        <Accordion>
          ...
          {hostMySellVeiclesList?.map((data) => (
                ...
                <div className="crp row row-cols-1">
                  <div className="col">
                    <div className="content-wrapper">
                      <DetailsTabSellCarComponent
                        hostMySellVeiclesList={data}
                      />
                    </div>
                  </div>
                </div>
