...
const DetailsTabSellCarComponent = (props) => {
  const {
    seatNumber,
    doorNumber,
    milesPerGallon,
      ...
      <div className="row g-2 g-xxl-3">
        <div className="col col-12">
          ...
          >
            ...
            <Tab eventKey="apr_charges" title="Sell Prices">
              <div className="apr_about">
                <div className="px-2">
                  <p>
              ...
              <div className="apr_about">
                <div className="px-2">
                  <p>
                    MILAGE AUTHORIZED: <strong>{authorizedMilage}</strong>
                  </p>
                </div>
              </div>
              <div className="apr_about">
...
export default DetailsTabSellCarComponent;
