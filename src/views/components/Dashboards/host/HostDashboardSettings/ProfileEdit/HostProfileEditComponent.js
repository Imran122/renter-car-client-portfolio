...
const HostProfileEditComponent = () => {
              ...
              <div className="row g-2">
                ...
                <div className="col col-12">
                  <div className="input-wrapper">
                    ...
                    <input
                      placeholder="45456566"
                      type="text"
                      className="cc-in form-control"
                      name="routingnumber"
                      defaultValue={userSingleData?.routingnumber}
                      onChange={handelOnChange}
                    />
                  </div>
                </div>
                <div className="col col-12">
                  <div className="input-wrapper">
                    ...
                    <input
                      ...
                      defaultValue={userSingleData?.bankaccountnumber}
                      onChange={handelOnChange}
                    />
                  </div>
                </div>
                <div className="col col-12">
                  <div className="input-wrapper">
                    ...
                    <input
                      placeholder="Citigroup Inc."
                      type="text"
                      className="cc-in form-control"
                      name="bankname"
                      defaultValue={userSingleData?.bankname}
                      onChange={handelOnChange}
                    />
                  </div>
                </div>
...
export default HostProfileEditComponent;
