...
import carCard from "../../../../../assets/images/car2.png";
import userImg from "../../../../../assets/images/usericon.png";
import useAuth from "../../../../../hooks/useAuth";
import { getCookie } from "../../../../../utilities/helper";
import "./MyFavourites.css";

const FavouritesCardCardsComponent = (props) => {
    ...
    return (
        <div className="col col-12 col-xl-6 fav-car-card">
            <article className="top-rated-car-card border-black8 rounded-0 h-100">
                ...
                <div className="top-rated-car-content">
                    ...
                    <div className="top-rated-car-card-footer d-flex justify-content-between align-items-center">
                        ...
                        <button
                            onClick={() => {
                                navigate(`/rent-car-details/${props.rentCarList._id}`, {
                                    replace: true,
                                });
                            }}
...
export default FavouritesCardCardsComponent;
