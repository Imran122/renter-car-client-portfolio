    ...
    <>
      <article className="cr-border p-4">
        ...
        <div className="d-md-flex justify-content-between align-items-center mt-2">
          <Link to={"/dashboard/settings/seller-edit-profile"}>
            <button
              type="submit"
      ...
      <article className="cr-border p-4 mt-4">
        ...
        <div className="d-md-flex justify-content-between align-items-center">
          ...
          <div>
            <Link to={"/dashboard/settings/seller-change-password"}>
              <button
                type="submit"
      ...
      {/*       <article className="cr-border p-4 mt-4">
        ...
        <div className="d-md-flex justify-content-between align-items-center">
          ...
          <div className="d-flex">
            ...
            <div className="car-book-request-user">
              <h5>Notification</h5>
              <p className="mt-4">
                <span>Notify me if seller approves my booking request</span>
              </p>
            </div>
          </div>
        ...
        <div className="d-md-flex justify-content-between align-items-center mt-2">
          ...
          <div className="d-flex">
            ...
            <div className="car-book-request-user">
              <p>
                <span>Notify me if seller reject my booking request</span>
              </p>
            </div>
          </div>
...
export default SellerSettingsComponent;
