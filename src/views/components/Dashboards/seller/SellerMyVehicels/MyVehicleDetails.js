...
import useSellerCarListForSell from "../../../../../hooks/useSellerCarListForSell";
import "./MyVehicles.css";

const MyVehicleDetails = () => {
  const [sellerMyVeiclesData, setSellerMyVeiclesData] =
    useSellerCarListForSell();
                ...
                <div className="crp row row-cols-1">
                  <div className="col">
                    <div className="content-wrapper">
                      <DetailsTab sellerMyVeiclesData={data} />
                    </div>
                  </div>
                </div>
